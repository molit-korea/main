...
| 팀명    | 인원수| 상훈 | 내용 | 활용 데이터 |
|---------|-------|------|-----|------------|
| 최적화맥스: 분노의 도로 | 이준혁 외 총 5명 | 국토부장관상 | 교통 흐름의 동적 시각화 및 인공지능 딥러닝을 이용한 예측 | 표준노드링크, ITS Open API, V-World 지도 |
| Gentri Hackers | 박민제 외 총 4명 | 국토연구원장상 | 젠트리피케이션 발생 원인 및 지역 예측을 통한 맞춤형 정책 제안 | 실거래가 정보 |
| 황금마티즈 | 김시온 외 총 5명 | 교통안전공단 이사장상 | DTG(전자기록계)의 정보와 교통사고 정보를 Spark엔진으로 분석하고 실제 승객의 피드백을 통해 운전 안전도 향상 | DTG, 교통사고 정보, 승객 평가 정보 |
| 도구스테 | 오진영 외 총 2명 | 한국교통연구원장상 | DTG 데이터를 활용한 광역 시내버스 개선 노선 도출 | DTG, 노선정보 |
| 미디어맵 | 이하늘 외 총 5명 | 국토연구원장상 | 미디어 기반 상권 분석을 통하여 미래 상권과 젠트리피케이션 분석 | TV, SNS, 블로그, 뉴스, 실거래가 |
